...
<main>
    ...
    <body class="body-bg">
           ...
           <div class="marquee-section fix">
               <div class="mycustom-marque">
                   <div class="scrolling-wrap">
                       <div class="comm">
                           <div class="cmn-textslide textitalick text-custom-storke">ABOUT US</div>
                           <div class="cmn-textslide textitalick">ABOUT US </div>
                           <div class="cmn-textslide textitalick text-custom-storke">ABOUT US </div>
                       </div>
                       <div class="comm">
                           <div class="cmn-textslide textitalick text-custom-storke">ABOUT US</div>
           ...
           <div class="container">
               <div class="section-title-area">
                   <div class="section-title">
                       ...
                       <h2 class="wow fadeInUp" data-wow-delay=".3s">Crafting Creative <span>Solutions for</span> <br> Modern Brands</h2>
                   </div>
                   <p class="wow fadeInUp" data-wow-delay=".5s">
                       At the intersection of vision and execution, we bring <br> creative ideas  team transforms concepts into <br> compelling narratives,
                   </p>
               </div>
                           ...
                           <div class="about-content">
                               <div class="about-icon-items wow fadeInUp" data-wow-delay=".3s">
                                   <div class="icon">
                                       ...
                                       <div class="line-bar">
                                           <img src="assets/img/about/line.png" alt="img">
                                       </div>
                                   </div>
                                   <div class="content">
                                       <h3>Our Mission</h3>
                               ...
                               <a href="about.html" class="theme-btn wow fadeInUp" data-wow-delay=".5s">More About Us</a>
                           </div>
                       </div>
                   </div>
               </div>
           ...
           <div class="container">
               <div class="row">
                   ...
                   <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                       <div class="counter-items">
                           <h2><span class="count">160</span>+</h2>
                           <p>WINNING AWARD</p>
                       </div>
                   </div>
               </div>
       ...
       <section class="service-section fix section-padding">
           <div class="container">
               <div class="section-title-area">
                   <div class="section-title">
                       ...
                       <h2 class="wow fadeInUp" data-wow-delay=".3s">Our Palette of <span>Expertise</span></h2>
                   </div>
               ...
               <div class="row g-0">
                   <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                       <div class="service-box-items">
                           <div class="icon">
                               <img src="assets\img\icon\web-development.png" alt="img"  style="height:100px;width:100px;">
                           </div>
                           <div class="content">
                               ...
                               <div class="service-btn">
                                   <a href="service-details.html" class="arrow-icon"><img src="assets/img/icon/02.svg" alt="img"></a>
                   ...
                   <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                       <div class="service-box-items">
                           <div class="icon">
                               <img src="assets\img\icon\smartphone.png" style="height:100px;width:100px;">
                           </div>
                           <div class="content">
                               <h3><a href="service-details.html">Packaging Design</a></h3>
                               <p>
                                   Our graphic design services cover everything from materials to digital graphics. We  clearly and effectively.
                               </p>
                               <div class="service-btn">
                   ...
                   <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                       <div class="service-box-items">
                           <div class="icon">
                               <img src="assets\img\icon\app-development.png" alt="img" style="height:100px;width:100px;">
                           </div>
                           <div class="content">
                   ...
                   <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                       <div class="service-box-items border-none">
                           <div class="icon">
                               <img src="assets\img\icon\social-media.png" alt="img" style="height:100px;width:100px;">
                           </div>
                           <div class="content">
                               <h3><a href="service-details.html">Print Design</a></h3>
                               <p>
                                   Our graphic design services cover everything from materials to digital graphics. We  clearly and effectively.
                               </p>
                               <div class="service-btn">
        ...
        <section class="portfolio-section fix section-bg section-padding">
           <div class="container">
               <div class="section-title-area">
                   <div class="section-title">
                       <h6 class="wow fadeInUp">Our Portfolio</h6>
                       <h2 class="wow fadeInUp" data-wow-delay=".3s">Some recent <span>work</span></h2>
                   </div>
                   <a href="project.html" class="theme-btn">See All Works</a>
               </div>
               <div class="row">
                   <div class="col-lg-12">
                       <div class="portfolio-box-items wow fadeInUp" data-wow-delay=".3s">
                           <div class="project-wrap">
                               <div class="content">
                                   <span>Website, UI/UX</span>
                                   <h3><a href="project-details.html">Building Brands from <br> the Ground Up</a></h3>
                               </div>
                               <p>
                                   This project involved creating a digital experience for a lifestyle brand targeting urban millennials. 
                               </p>
                           </div>
                           <a href="project-details.html" class="radius-btn">
                               <i class="fa-sharp fa-solid fa-arrow-right"></i>
                               View Details
                           </a>
                           <div class="project-hover d-none d-md-block bg-cover" style="background-image: url('assets/img/project/hover-img.jpg');"></div>
                       </div>
                       <div class="portfolio-box-items wow fadeInUp" data-wow-delay=".3s">
                           <div class="project-wrap">
                               <div class="content">
       ...
       <section class="team-section fix section-padding">
           <div class="container">
               <div class="section-title text-center">
                   <h6 class="wow fadeInUp">Our Members</h6>
                   <h2 class="wow fadeInUp" data-wow-delay=".3s">Meet The <span>Team</span></h2>
               </div>
               <div class="row">
                   <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                       ...
                       <div class="col-lg-5">
                           <div class="testimonial-content">
                               <div class="section-title">
                                   ...
                                   <h2 class="wow fadeInUp" data-wow-delay=".3s">Client <span>Feedback</span></h2>
                               </div>
                               <p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                   From concept to execution, Agenko nailed every aspect of our campaign. Their expertise and creativity have taken our brand to the next level. 
                               </p>
                           </div>
                       </div>
                   </div>
       ...
       <!-- Brand Section Start -->
       <div class="brand-section section-padding fix pt-0 section-bg">
           <div class="container">
               <div class="brand-text">
                   <h5>CLIENTS I’VE WORKED WITH</h5>
               </div>
       ...
       <section class="lets-talk-section fix section-padding pb-0">
           <div class="container">
               <div class="lets-talk-wrapper">
                   <h2 class="wow fadeInUp" data-wow-delay=".3s">Have a project in mind? Let’s <br> work together!</h2>
                   <a href="contact.html" class="theme-btn wow fadeInUp" data-wow-delay=".5s">Let’s Talk!</a>
               </div>
           </div>
       </section>
